...
public class ObservationListActionsViewImpl extends Composite implements IObservationListActionsView {
   ...
   ObservationListPlace observationListPlace = null;
   ...
   protected void handleStationDoubleClick (ClickEvent e) {
      ObservationListPlace place = null;
      IStationProxy selected = stationSelectionModel.getSelectedObject ();
      
      if (selected != null) {
         place = new ObservationListPlace ();
         place.setObservationType (observationListPlace.getObservationType ());
         place.setRepresentation (observationListPlace.getRepresentation ());
         place.setStationId (selected.getId ());
         placeController.goTo (place);
      }
   }

   @Override
   public void setInput (IRequestFactory requestFactory, ObservationListPlace observationListPlace) {
