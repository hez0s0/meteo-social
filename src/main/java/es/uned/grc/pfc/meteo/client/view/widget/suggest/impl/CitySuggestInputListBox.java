...
public class CitySuggestInputListBox extends EntitySuggestInputListBox <String, IStationRequestContext, IStringPagedListProxy> {

   @Override
   protected EntitySuggestBox <String, IStationRequestContext, IStringPagedListProxy> createEntitySuggestBox (TextBox textBox) {
      return new CitySuggestBox (textBox);
   }
