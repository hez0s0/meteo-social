...
public class CitySuggestBox extends EntitySuggestBox <String, IStationRequestContext, IStringPagedListProxy> {
   
   public CitySuggestBox (TextBox textBox) {
      super (textBox);
   }
