...
/**
 * A TextInputCell whose keypress event can be used ... unfortunately
 * TextInputCell cannot be extended, so i had to re-create it with the silly
 * change.
 */
public class KeypressableTextInputCell extends AbstractInputCell <String, KeypressableTextInputCell.ViewData> {
