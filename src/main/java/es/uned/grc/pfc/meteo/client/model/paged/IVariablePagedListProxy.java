 ...
 */
@ProxyFor (value = VariablePagedList.class)
public interface IVariablePagedListProxy extends ValueProxy, IPagedListProxy <IVariableProxy>  {
   List <IVariableProxy> getList ();
}
